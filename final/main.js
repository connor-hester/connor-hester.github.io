let images=["media/01.png","media/02.png","media/03.png","media/04.png","media/05.png","media/06.png","media/007.png","media/08.png","media/09.png","media/10.png","media/011.png","media/12.png","media/13.png","media/014.png","media/015.png","media/16.png","media/17.png","media/18.png","media/19.png","media/20.png","media/21.png","media/22.png","media/23.png","media/24.png","media/25.png","media/26.png","media/027.png","media/28.png","media/29.png","media/030.png","media/31.png","media/32.png","media/33.png","media/34.png","media/35.png","media/36.png","media/037.png","media/38.png"];
...
let captionButton=document.querySelector("#button3");
let word1;
let word2;
let selectedPhrase;
let phraseArray;
...
let phrase5=["when ",null," says they want a(n) ",null];
...
let phrase10=["when you get cancelled for calling some a",null, " ",null," on twitter"];
...
let phrase25=["when your spouse wants a divorce because of your ",null," ",null];
...
const thirdPersonVerbs=["cries","screams","annoys", "arrests", "asks", "attacks", "attempts", "avoids", "bakes", "bans", "begs", "bleaches", "bombs", "breathes", "causes", "cheats", "chokes", "confesses", "confuses", "copies", "coughs", "crashes", "dances", "destroys", "drags", "despises", "exists", "explodes", "fails", "fears", "forces", "frightens", "glues", "greases", "harasses", "hates", "hunts", "ignores", "injures", "kills", "kisses", "laughs", "lies", "likes", "loves", "marries", "milks", "mixes", "murders", "offends", "pecks", "pokes", "pops", "pulls", "punches", "punishes", "realizes", "removes", "replaces", "robs", "rots", "ruins", "screws", "shocks", "slaps", "smashes", "smokes", "spills", "starts", "squeezes", "sucks", "suffers", "surprises", "traps", "tricks", "trys", "undresses", "walks", "waits", "waves", "whips", "whispers", "wishes", "worries", "wrecks", "yells"];
const presentVerbs=["cry","scream","annoy", "arrest", "ask", "attack", "attempt", "avoid", "bake", "ban", "beg", "bleach", "bomb", "breathe", "cause", "cheat", "choke", "confess", "confuse", "copy", "cough", "crash", "dance", "destroy", "drag", "despise", "exist", "explode", "fail", "fear", "force", "frighten", "glue", "grease", "harass", "hate", "hunt", "ignore", "injure", "kill", "kiss", "laugh", "lie", "like", "love", "marry", "milk", "mix", "murder", "offend", "peck", "poke", "pop", "pull", "punch", "punish", "realize", "remove", "replace", "rob", "rot", "ruin", "screw", "shock", "slap", "smash", "smoke", "spill", "start", "squeeze", "suck", "suffer", "surprise", "trap", "trick", "try", "undress", "walk", "wait", "wave", "whip", "whisper", "wish", "worry", "wreck", "yell"];
const ingVerbs=["crying","screaming","annoying", "arresting", "asking", "attacking", "attempting", "avoiding", "baking", "banning", "begging", "bleaching", "bombing", "breathing", "causing", "cheating", "choking", "confessing", "confusing", "copying", "coughing", "crashing", "dancing", "destroying", "dragging", "despising", "existing", "exploding", "failing", "fearing", "forcing", "frightening", "gluing", "greasing", "harassing", "hating", "hunting", "ignoring", "injuring", "killing", "kissing", "laughing", "lying", "liking", "loving", "marrying", "milking", "mixing", "murdering", "offending", "pecking", "poking", "popping", "pulling", "punching", "punishing", "realizing", "removing", "replacing", "robbing", "rotting", "ruining", "screwing", "shocking", "slapping", "smashing", "smoking", "spilling", "starting", "squeezing", "sucking", "suffering", "surprising", "trapping", "tricking", "trying", "undressing", "walking", "waiting", "waving", "whipping", "whispering", "wishing", "worrying", "wrecking", "yelling"];
const adjectives=["thiqq", "sadistic", "duck-like", "offensive", "addicting", "afraid", "gorilla-grip", "angry", "annoyed", "anxious", "awful", "beautiful", "big", "bitter", "black", "blue", "broken", "bumpy", "cold", "colossal", "confused", "ultra-thicc", "creepy", "cruel", "cuddly", "curvy", "damp", "dangerous", "deafening", "dead", "delicious", "depressed", "dirty", "disgusted", "disturbed", "dizzy", "dry", "dusty", "embarrassed", "empty", "energetic", "enthusiastic", "envious", "evil", "fantastic", "fast", "far", "few", "fierce", "filthy", "flaky", "flat", "fluffy", "foolish", "fresh", "friendly", "frightened", "fuzzy", "gigantic", "gorgeous", "greasy", "grubby", "grotesque", "handsome", "hard", "harsh", "heavy", "helpless", "high", "hilarious", "hissing", "homeless", "horrible", "hot", "huge", "hungry", "hurt", "icy", "immense", "itchy", "jealous", "jittery", "juicy", "large", "lazy", "little", "lonely", "long", "loose", "loud", "lucky", "massive", "melted", "mighty", "moaning", "modern", "mute", "mysterious", "nasty", "naughty", "nervous", "obedient", "obnoxious", "odd", "old", "orange", "ordinary", "outrageous", "panicky", "petite", "plastic", "precious", "pretty", "prickly", "proud", "puny", "purple", "purring", "quiet", "rapid", "rare", "raspy", "ratty", "red", "repulsive", "ripe", "roasted", "rotten", "rough", "round", "sad", "salty", "scary", "scrawny", "screeching", "selfish", "shaky", "shallow", "sharp", "shivering", "short", "shrill", "silent", "silky", "skinny", "slimy", "slippery", "slow", "small", "smart", "soft", "sore", "sour", "spicy", "square", "squealing", "stale", "sticky", "straight", "strange", "strong", "tall", "tan", "tasty", "tender", "tense", "terrible", "thirsty", "tight", "tiny", "tired", "tough", "ugliest", "ugly", "watery", "weak", "wet", "wicked", "wide", "yellow", "young", "yummy"];
const singularNouns=["thigh", "bra", "relationship", "face", "woman", "falcon", "poverty", "forced sterilization", "dump truck", "ukelele", "bisexuality", "homosexuality", "world peace", "gay agenda", "goblin", "diversity", "sexual tension", "free sample", "neck", "white person", "severed head", "blood of Christ", "milkman", "gorilla", "nipple", "banana", "flightless bird", "chemical warfare","late-stage Capitalism", "Socialism", "mayo", "meme", "wifi password","chainsaw","rainbow","fetus","lukewarm meat","lumberjack","earwax","threesome","Liberal","Conservative","science","natural selection","crucifixion","child","adderall","bean","lifetime of sadness","tumor","rap music", "fetish","yeast","octopus","cigarette","Scientology","Subaru","personality","ghost","horse meat","autocannibalism","alchoholism","teen pregnancy","antichrist","lactation","dead bird","ex-wife","corpse","hard boiled egg","oompa loompa","leprosy","soup","stab wound","sperm whale","PTSD","war crime","declaration of independence","puberty","violence","bacteria","assault rifle","yogurt","gogurt","racism","vending machine","spontaneous combustion","anti-vaxxer","vomit","white privilege","police brutality","toxic masculinity","childbirth","butter","landmine","vehicular manslaughter","arson","tax evasion","murder"];
const pluralNouns=["thighs", "bras", "faces", "women", "falcons", "forced sterilizations", "ukeleles", "goblins", "free samples", "severed heads", "gorillas", "nipples", "bananas", "flightless birds",  "hot cheetos", "memes", "chainsaws","rainbows","fetuses","lukewarm meats","lumberjacks","toenails","threesome","Liberals","Conservatives","children","beans","tumors", "fetishes","cigarettes","ghosts","dead birds","ex-wives","corpses","hard boiled eggs","oompa loompas","stab wounds","sperm whales","war crimes","assault rifles","vending machines","anti-vaxxers","landmines","explosions","Lunchables","men","battlefield amputations","inner demons","boy scouts","human rights","daddy issues","jazz hands","Hillary Clintons emails","Amish people","pain killers","pillz"];
const people=[ "Arnold Schwarzenegger","Mike Pence", "Vladimir Putin", "Jesus","Donald Trump", "Hilary Clinton", "Oprah","Geico", "Stephen Hawking", "Batman","Darth Vader","your mom","your dad","your brother","your grandma","your grandpa","your sister","your dog","Danny DeVito","Ronald Reagan","Justin Bieber","The Patriarchy","Stalin","Dwayne 'The Rock' Johnson","Megan Thee Stallion","Nicki Minaj","Nicholas Cage","Martha Stewart","Abraham Lincoln","Kim Kardashian","Kanye","The Hamburglar","Judge Judy","The Kool-Aid Man","The Pope"];
...
function generateMeme(){
    ...
    fillPhrase();
    toString();
    topBox.textContent=topTextContent;
    bottomBox.textContent=bottomTextContent;
}
...
function fillPhrase(){
    if(selectedPhrase===phrase1){
        word1=thirdPersonVerbs[Math.floor(Math.random()*86)];
